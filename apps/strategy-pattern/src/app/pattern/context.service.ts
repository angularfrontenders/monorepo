...
export class ContextService {
    public constructor(@Inject(strategies.StrategyToken) private _strategies: Array<strategies.IStrategy>) {}
    ...
    public applyStrategy(value: IConfiguration): void {
        const strategiesFounded: Array<strategies.IStrategy> = this._strategies
            ...
            .sort((strategyA: strategies.IStrategy, strategyB: strategies.IStrategy) => {
